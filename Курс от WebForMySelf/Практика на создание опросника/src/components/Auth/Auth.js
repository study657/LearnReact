...
class Auth extends Component{
    ...
    loginHandler = async () => {
        ...
        try{
            const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBzFgtqZ0gSd6AcQnn6cf4eGnYkjK5NEUQ', authData);
